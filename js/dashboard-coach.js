...
const ALUMNOS_COACH = [
    { nombre: 'Javier García', correo: 'javier@example.com', clase: 'Crossfit', estado: 'activo' },
    { nombre: 'María López', correo: 'maria@example.com', clase: 'Crossfit', estado: 'activo' },
    { nombre: 'Carlos Morales', correo: 'carlos@example.com', clase: 'Funcional', estado: 'activo' },
    { nombre: 'Ana Rodríguez', correo: 'ana@example.com', clase: 'Yoga', estado: 'activo' },
    { nombre: 'Pedro Sánchez', correo: 'pedro@example.com', clase: 'Crossfit', estado: 'inactivo' }
];
